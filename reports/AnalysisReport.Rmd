...
This report investigates and provides insights on the data set collected for the Cyber Security: (Safety At Home, Online, and in Life) course developed by Newcastle University and offered by the Future Learn Platfrom which is a massive open online course (MOOC).
...
\underline{\textbf{1.4 Exploratory Data Analysis and Visualizations:}}
...
\textbf{Research Question:} What is the primary reason for re-enrollment, related to the total course hours required?
